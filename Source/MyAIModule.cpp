...
void MyAIModule::onMatchUp() {
  exportDataAndExit("./bwdata.h", "./bwdata.cpp");
}
...
void MyAIModule::onFrame()
{
  ...
  Broodwar->drawTextScreen(10, 10,  "FPS: %d", Broodwar->getFPS() );
  Broodwar->drawTextScreen(10, 20, "Average FPS: %f", Broodwar->getAverageFPS() );
